...
final class QuestionsViewController: UIViewController {
    ...
    // MARK: - IB Actions
    @IBAction func singleQuestionBtnDidTapped(_ sender: UIButton) {
    ...
    @IBAction func multipleQuestionBtnDidTapped() {
    ...
    @IBAction func rangedQuestionBtnDidTapped() {
        //round integer to float
